const JUMPS = [
  { key: "f1", appName: "Code" },
  { key: "1", modifiers: ["ctrl", "cmd"], appName: "Code" },

  { key: "f2", appName: "Brave Browser" },
  { key: "2", modifiers: ["ctrl", "cmd"], appName: "Brave Browser" },
...
JUMPS.forEach(({ key, modifiers, appName }) => {
  hotkey({ name: appName, group: "Jump to", key, modifiers }, async () => {
